...
('BRAVIA2BX400', '', 'Sony Bravia 32IN FULLHD KDL-32BX400', 'Caracterï¿½sticas:Full HD: Vea deportes pelï¿½culas y juegos con magnï¿½ficos detalles en alta resoluciï¿½n gracias a la resoluciï¿½n 1920x1080.HDMIï¿½: 4 entradas (3 en la parte posterior, 1 en el lateral)USB Media Player: Disfrute de pelï¿½culas, fotos y mï¿½sica en el televisor.Sintonizador de TV HD MPEG-4 AVC integrado: olvï¿½dese del codificador y acceda a servicios de TV que incluyen canales HD con el sintonizador DVB-T y DVB-C integrado con decodificador MPEG4 AVC (dependiendo del paï¿½s y sï¿½lo con operadores compatibles)Sensor de luz: ajusta automï¿½ticamente el brillo segï¿½n el nivel de la iluminaciï¿½n ambiental para que pueda disfrutar de una calidad de imagen ï¿½ptima sin consumo innecesario de energï¿½a.BRAVIA Sync: controle su sistema de ocio domï¿½stico entero con un mismo mando a distancia universal que le permite reproducir contenidos o ajustar la configuraciï¿½n de los dispositivos compatibles con un solo botï¿½n.BRAVIA ENGINE 2: experimente colores y detalles de imagen increï¿½blemente nï¿½tidos y definidos. Live Colour?: seleccione entre cuatro modos: desactivado, bajo, medio y alto, para ajustar el color y obtener imï¿½genes vivas y una calidad ï¿½ptima. 24p True Cinema?: reproduzca una autï¿½ntica experiencia cinemï¿½tica y disfrute de pelï¿½culas exactamente como el director las concibiï¿½ a 24 fotogramas por segundo.', '355.70', 'TV'),
...
('IXUS115HSAZ', '', 'Canon Ixus 115HS azul', 'Caracterï¿½sticas:HS System (12,1 MP) Zoom 4x, 28 mm. IS ï¿½ptico Cuerpo metï¿½lico estilizado Pantalla LCD PureColor II G de 7,6 cm (3,0', '196.70', 'CAMARA'),
('KSTDT101G2', '', 'Kingston DataTraveler 16GB DT101G2 USB2.0 negro', 'Caracterï¿½sticas:Capacidades ? 16GBDimensiones ? 2.19', '19.20', 'MEMFLA'),
...
('KSTMSDHC8GB', '', 'Kingston MicroSDHC 8GB', 'Kingston tarjeta de memoria flash 8 GB microSDHCï¿½ndice de velocidad    Class 4Capacidad almacenamiento    8 GBFactor de forma  MicroSDHCAdaptador de memoria incluido   Adaptador microSDHC a SDGarantï¿½a del fabricante   Garantï¿½a limitada de por vida', '10.20', 'MEMFLA'),
...
('dwes', '0d7f943d633e49fb06fe6c53acabe3c5');
